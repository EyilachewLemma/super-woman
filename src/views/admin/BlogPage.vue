<template>
  ...
  <base-card>
    <div class="d-flex justify-content-between">
      ...
      <div class="mb-3">
        ...
        <select
          ...
          v-model="sortBlog"
          id="interestedin"
          @change="sortBlogsBy($event, sortingBlogs)"
        >
        ...
        >
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div
                class="w-100 reviews d-flex justify-content-between pt-2 pb-3 px-1"
              >
                <div class="view me-3">
                  <i class="fas fa-eye icon"></i> {{ blog.view }}
                </div>
                <div class="likes me-3">
                  <i class="fas fa-thumbs-up icon"></i> {{ blog.like }}
                </div>
                <div class="comments me-3">
                  <i class="fas fa-comment-alt icon"></i> {{ blog.comment }}
                </div>
                <div class="shars me-3">
                  <i class="fas fa-share icon"></i> {{ blog.share }}
                </div>
                <div
                  class="verification"
                  :class="{ verified: blog.is_verified === 1 }"
                >
                  {{ isVerified(blog.is_verified) }}
                </div>
              </div>
            </div>
          </div>
    ...
    <div v-if="blogs.data?.length" class="d-flex justify-content-end mt-3 me-5">
      <div class="rowsperpage me-3">Blogs per Page</div>
      ...
      <div class="leftchivron ms-3 me-3">
        <button
          @click="backChivron()"
          class="chivronbtn"
          :class="{ active: blogs.meta.from !== 1 }"
          :disabled="blogs.meta.from === 1"
        >
      ...
      <div class="rightchivron">
        <button
          ...
          class="chivronbtn"
          :class="{ active: blogs.meta.to !== blogs.meta.total }"
          :disabled="blogs.meta.to === blogs.meta.total"
        >
